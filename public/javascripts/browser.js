...
var ReactApp = React.createClass({
  ...
  componentDidMount: function() {
    ...
    fetch('/data').then((function(response) {
      ...
      return $__0.setState({images: result.data.children});
    }), (function(err) {
      return console.log(err);
    }));
  },
  render: function() {
    return (React.createElement("ul", null, this.state.images.map((function(image) {
      return React.createElement("li", null, React.createElement("img", {src: image.data.thumbnail}), React.createElement("div", null, image.data.title), React.createElement("div", null, "Score: ", image.data.score, " | Ups: ", image.data.ups, " | Downs: ", image.data.downs));
    }))));
  }
});
...
//# sourceURL=/Users/leapoahead/Code/tmp/isomorphic-react/app/ReactApp.js
},{"react":157}],2:[function(require,module,exports){
"use strict";
var ReactApp = require('./ReactApp');
var React = require('react');
React.render(React.createElement(ReactApp), document.getElementById('app-mount-point'));
console.log('OK');


//# sourceURL=/Users/leapoahead/Code/tmp/isomorphic-react/app/fake_e12aadc7.js
},{"./ReactApp":1,"react":157}],3:[function(require,module,exports){
/**
